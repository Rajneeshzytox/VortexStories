...
export default function Header(){
    return(
        <>
        <header className="header min-h-20 h-fit flex justify-between items-center pl-20 py-4 gap-6 flex-wrap first-letter pr-10 min-w-52 sticky top-0 backdrop-blur-sm">
        {/* headee */}
